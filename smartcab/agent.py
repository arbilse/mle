...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (waypoint, inputs['light'], inputs['left'], inputs['right'], inputs['oncoming']) # keeping right input/though technically unecessary for optimal policy
    ...
    def createQ(self, state):
        ...
        if not state in self.Q:
            self.Q[state] = self.template_q.compy()
